...
Three data points were removed because they contained erroneous data ($PNM\leq 0$). For the PNM, only validation data of \ce{NO3} is used, because accurate \ce{NH4} data were not available for the calibration data. 
...
\begin{table}[h] %Table Field information
	...
	\begin{tabu} to \textwidth{@{}X[1.2,l]X[c]X[c]X[c]X[c]X[c]@{}}% {@{}rrrrrrr@{}} 
		\toprule	\rowfont{\bfseries}
...
% * <jobdepater@gmail.com> 2015-10-09T09:33:09.014Z:
%
% 
%
...
\begin{figure}
\subfigure[Predicted values plotted versus measured values.]{
    \includegraphics[width=0.5\linewidth]{results_val_pm}}
  %\caption{1a}
  \label{fig:val_pm}
\quad
\subfigure[Cumulative N mineralization with predicted slopes]{
    \includegraphics[width=0.5\linewidth]{results_val_ncum}}
 %\caption{1b}
  \label{fig:val_ncum}
%\end{subfigure}
...
\begin{table}[h] %Table Field information
	...
	\begin{tabu} to \textwidth{@{}X[3,l]X[l]X[l]X[l]X[l]X[l]X[l]X[l]X[l]@{}}% {@{}rrrrrrr@{}} 
	\toprule \rowfont{\bfseries}
     & \multicolumn{2}{c}{Farm A} & \multicolumn{2}{c}{Farm B} & \multicolumn{2}{c}{Farm C} & \multicolumn{2}{c}{Farm D} \\
...
\begin{figure}
\subfigure[Data: all. Response: PNM.]{
    \includegraphics[width=0.45\linewidth]{results_pls_totpnm}}
  \label{fig:pls_totpnm}
  \quad
\subfigure[Data: all. Response: BFI.]{
    \includegraphics[width=0.45\linewidth]{results_pls_totbfi}}
  \label{fig:pls_totbfi}
    \quad
     \subfigure[Data: mineral soils. Response: PNM.]{
    \includegraphics[width=0.45\linewidth]{results_pls_minpnm}}
  \label{fig:pls_minpnm}
  \quad
\subfigure[Data: mineral soils. Response: BFI.]{
    \includegraphics[width=0.45\linewidth]{results_pls_minbfi}}
  \label{fig:pls_minbfi}
  \quad
\subfigure[Data: sandy soils. Response: PNM.]{
    \includegraphics[width=0.45\linewidth]{results_pls_sanpnm}}
  \label{fig:pls_sanpnm}
    \quad
\subfigure[Data: sandy soils. Response: BFI.]{
    \includegraphics[width=0.45\linewidth]{results_pls_sanbfi}}
